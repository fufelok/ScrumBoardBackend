...
public class Testing
{
    ...
    private static ArrayList<WorkItem> workItems;
    private User user;
    ...
    public void assertThatUserCanBeDeleted(){
        ...
        assertEquals("User was removed", null, ticketSystemService.getUserWithID("920406"));
    ...
    public void updateUserTest(){
        ...
        ticketSystemService.addUser(user);
        User updatedUser = ticketSystemService.getUserWithUserName("Kira");
        updatedUser.setPassword("111");
        User user1=ticketSystemService.updateUser(updatedUser);
    ...
    public void assertThanUsersCanBeReceivedByWorkItem(){
        ...
        ticketSystemService.addUser(user);
        assertThat("920406", is(ticketSystemService.getUsersWithWorkItem(workItem).get(0).getUserID()));
    }

    @Test
    public void getAllUsersFromTeamTest(){
        Team team = new Team ("Leanbit");
        ticketSystemService.addTeam(team);

        user = new User("920406", "Kira", "Erik", "Welander", "Elfen", team);
        User user1 = new User("110406", "fufelok", "Vitalij", "Bajkov", "Elfen", team);
        ticketSystemService.addUser(user);
        ticketSystemService.addUser(user1);

        assertThat (2, is(ticketSystemService.getAllUsersFromTeam(team.getTeamName()).size()));
    }
    ...
    public void addWorkItemTest(){
        WorkItem workItem =  new WorkItem("Fixdisshit", "BLAH", "DO_IT", 9001);
        WorkItem newWorkItem = ticketSystemService.addWorkItem(workItem);
        newWorkItem = ticketSystemService.getWorkItem(newWorkItem.getName());
    ...
    public void updateWorkItemTest(){
        WorkItem workItem =  new WorkItem("Fixdisshit", "BLAH", "DO_IT", 9001);
        ticketSystemService.addWorkItem(workItem);
        WorkItem updatedWorkItem =  ticketSystemService.getWorkItem("Fixdisshit");
        updatedWorkItem.setPriority(12);
        assertThat(ticketSystemService.updateWorkItem(updatedWorkItem).getPriority(), is(12));
    }

    @Test
    public void removeWorkItemTest(){
        WorkItem workItem =  new WorkItem("Fixdisshit", "BLAH", "DO_IT", 9001);
        ticketSystemService.addWorkItem(workItem);
        WorkItem deletedWorkItem =  ticketSystemService.getWorkItem(workItem.getName());
        ticketSystemService.removeWorkItem(deletedWorkItem);
        assertEquals( ticketSystemService.getWorkItem(deletedWorkItem.getName()), null);
    }

    @Test
    public void addWorkItemToUserAndGetWorkItemsFromTeamTest(){
        ticketSystemService.addWorkItem(new WorkItem("heloooo", "BLAH", "DO_IT", 9001));
        ...
        Team team = new Team("woooooo");
        ticketSystemService.addTeam(team);
        user = new User("920406", "Aseel", "Aseel", "wwwwww", "Elfen", team);
        ticketSystemService.addUser(user);
        User user1 = new User("110433", "Inas", "Inna", "Erkisson", "Elfen", team);
        ticketSystemService.addUser(user1);
        ticketSystemService.addWorkItemToUser(ticketSystemService.getUserWithUserName("Aseel"),ticketSystemService.getWorkItem("heloooo"));
        ticketSystemService.addWorkItemToUser(ticketSystemService.getUserWithUserName("Aseel"),ticketSystemService.getWorkItem("meeeee"));
        ticketSystemService.addWorkItemToUser(ticketSystemService.getUserWithUserName("Inas"),ticketSystemService.getWorkItem("diiiii"));
        workItems = (ArrayList<WorkItem>) ticketSystemService.getWorkItemsFromTeam(ticketSystemService.getTeam("woooooo"));
    ...
    public void getWorkItemsWithIssue(){
        WorkItem workItem = new WorkItem("heloooo", "BLAH", "DO_IT", 9001);
        WorkItem workItem2 = new WorkItem("meeeee", "Bibib", "DOIT", 3);
        ticketSystemService.addWorkItem(workItem);
        ticketSystemService.addWorkItem(workItem2);
        Issue issue = new Issue("hello","blabla",1);
        workItem.setIssue(issue);
        workItem2.setIssue(issue);
        ticketSystemService.addWorkItem(workItem);
        ticketSystemService.addWorkItem(workItem2);
        assertThat("should have two work items with issuies", 2, is(ticketSystemService.getWorkItemsWithIssue().size()));
    }

    @Test
    public void getAllWorkItemsWithStatus(){
        WorkItem workItem1 = new WorkItem("heloooo", "BLAH", "DO_IT", 9001);
        WorkItem workItem2 = new WorkItem("meeeee", "Bibib", "DOIT", 3);
        WorkItem workItem3 = new WorkItem("diiiii", "loooo", "DOIT", 2);
        ticketSystemService.addWorkItem(workItem1);
        ticketSystemService.addWorkItem(workItem2);
        ticketSystemService.addWorkItem(workItem3);
        assertThat( 2, is(ticketSystemService.getAllWorkItemsWithStatus("DOIT").size()));
    }


    @Test
    public void getWorkItemWithDescriptionLike(){
        WorkItem workItem1 = new WorkItem("heloooo", "This test contains LIKE in reposirory.", "DO_IT", 9001);
        ticketSystemService.addWorkItem(workItem1);
        assertThat( 1, is(ticketSystemService.getWorkItemWithDescriptionLike("contains LIKE").size()));
    }

    @Test
    public void getWorkItemsFromUser(){
        ...
        ticketSystemService.addUser(user);
        assertThat( 1, is(ticketSystemService.getWorkItemsFromUser("920406").size()));

    }

    @Test
    public void canChangeWorkItemStatusTest (){
        WorkItem workItem1 = new WorkItem("heloooo", "This test contains LIKE in reposirory.", "DO_IT", 9001);
        ticketSystemService.addWorkItem(workItem1);
        ticketSystemService.changeWorkItemStatus(workItem1, "DONE");
        assertThat("DONE", is(ticketSystemService.getWorkItem("heloooo").getStatus()));
    ...
    public void addIssueTest(){
        Issue issue = new Issue("hello","blabla",1);
        Issue newIssue = ticketSystemService.addIssue(issue);
        newIssue = ticketSystemService.getIssue(issue.getId());
    ...
    public void updateIssue(){
        ...
        Issue updatedIssue = ticketSystemService.getIssue(1L);
        updatedIssue.setName("hejhej");
        assertThat(ticketSystemService.updateIssue(updatedIssue).getName(), equalTo("hejhej"));
        assertEquals(updatedIssue, ticketSystemService.updateIssue(updatedIssue));
    }
    ...
    public void removeIssue(){
        Issue issue = new Issue("hello","blabla",1);
        ticketSystemService.addIssue(issue);
        Issue deletedIssue = ticketSystemService.getIssue(1L);
        ticketSystemService.removeIssue(deletedIssue.getId());
        assertThat(ticketSystemService.getIssue(deletedIssue.getId()), equalTo(null));
    }
